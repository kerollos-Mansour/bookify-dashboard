...
export default function HotelForm({
    ...
    const handleChange = (
        ...
        if (name.includes("location.")) {
            ...
            setFormData((prev) => ({
                ...prev,
                [name]: type === "checkbox" ? (e.target as HTMLInputElement).checked : getParsedValue(value),
            }));
        }
    };
                ...
                <div className="p-6">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            ...
                            <div className="space-y-4">
                                <div className="space-y-1">
                                    <label className="text-sm font-medium text-gray-700 dark:text-gray-300">Price Range (Low - High)</label>
                            ...
                            <div className="space-y-4 sm:col-span-2">
                                ...
                                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                    ...
                                    <div className="grid grid-cols-2 gap-4 sm:col-span-2">
                                        ...
                                        <div className="space-y-1">
                                            <label className="text-sm font-medium text-gray-700 dark:text-gray-300">Country Code</label>
                                            <input
                                                type="text"
                                    ...
                                    <div className="grid grid-cols-2 gap-4 sm:col-span-2">
                                        <div className="space-y-1">
                                            ...
                                            <input
                                                ...
                                                step="any"
                                                value={formData.location?.latitude === 0 ? "" : formData.location?.latitude}
                                                onChange={handleChange}
                                                className="w-full rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 px-4 py-2 text-sm focus:border-brand-500 focus:outline-hidden"
                                            />
                                        </div>
                                        <div className="space-y-1">
                                            ...
                                            <input
                                                ...
                                                step="any"
                                                value={formData.location?.longitude === 0 ? "" : formData.location?.longitude}
                                                onChange={handleChange}
                                                className="w-full rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 px-4 py-2 text-sm focus:border-brand-500 focus:outline-hidden"
                                            />
                                        </div>
                            ...
                            <div className="space-y-4 sm:col-span-2">
                                ...
                                <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
                                    ...
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8 text-gray-400 group-hover:text-brand-500 mb-2">
